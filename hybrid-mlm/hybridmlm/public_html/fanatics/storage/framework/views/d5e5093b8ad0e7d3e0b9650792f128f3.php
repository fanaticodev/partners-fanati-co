<?php $__env->startSection('content'); ?>
    <?php echo defineFilter('badge', '', 'header'); ?>
    ...
    <div class="row detailedGraphs">
        <div class="col-md-3 col-sm-3 co-xs-12 navWrapper">
            <ul class="navHolder">
                <?php echo defineFilter('dashboardBlock', '', 'detailedGraphsNav'); ?>
        ...
        <div class="graphPaneWrapper col-md-9 col-sm-9 co-xs-12">
            <div class="innerHolder unitHolder" data-unit="commissionDetailedGraph"></div>
        </div>
    </div>
    <div class="row overviewGraph-Section">
        <?php echo defineFilter('dashboardBlock', '', 'overview'); ?>

    </div>
    <div class="row rankPack-PieGraph">
        <?php echo defineFilter('dashboardBlock', '', 'serviceCountryMap'); ?>

    </div>
    <?php echo defineFilter('dashboardBlock', '', 'detailsBlock1'); ?>
    ...
    <div class="row lastJoiningsAndActivities">
        ...
        <?php echo defineFilter('dashboardBlock', '', 'detailsBlock2'); ?>

    </div>
    <div class="row linksHolder">
        <?php echo defineFilter('dashboardBlock', '', 'afterTopJoiningAndEarnersTile'); ?>

    </div>
    <?php echo defineFilter('promotionalSection', '', 'header'); ?>

    <?php echo defineFilter('dashboardBlock', '', 'beforeSystemModules'); ?>
    ...
    <script type="text/javascript">
        ...
        function getUnit(element, unit, args, postData, partial) {
            ...
            return $.post('<?php echo e(route('dashboard.unit')); ?>', options, function (response) {
                jQuerize(element).html(!partial ? response : $(response).find(partial).html());
            });
        }

        function countupStats(targetElement, startVal, endVal, formattingFn, decimal = 0) {
            var options = {
                useEasing: true,
                useGrouping: true,
                separator: ',',
            ...
            var countup = new CountUp(targetElement, Number(startVal), Number(endVal), decimal, 2.5, options);
        ...
        function setupBusinessBlockSummaryGraph(options) {
            var defaults = {
                dataSetLabel: 'Stats',
                labels: [
                    "<?php echo e(_t('index.january')); ?>", "<?php echo e(_t('index.february')); ?>", "<?php echo e(_t('index.march')); ?>", "<?php echo e(_t('index.april')); ?>", "<?php echo e(_t('index.may')); ?>", "<?php echo e(_t('index.june')); ?>", "<?php echo e(_t('index.july')); ?>", "<?php echo e(_t('index.august')); ?>", "<?php echo e(_t('index.september')); ?>", "<?php echo e(_t('index.october')); ?>",
                ],
                data: [],
                gradient: {
                    bg: [0, 0, 0, 240],
...
<?php echo $__env->make(ucfirst(getScope()).'.Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/app/Components/Themes/Base/Templates/Admin/Dashboard/index.blade.php ENDPATH**/ ?>