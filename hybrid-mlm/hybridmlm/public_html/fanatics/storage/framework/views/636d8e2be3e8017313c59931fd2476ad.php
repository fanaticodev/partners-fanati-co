    ...
    <div class="quickSideBarInner">
        <div class="panelNavWrapper">
            <div class="panelNav active" data-target="optimizer">
                <i class="fa fa-rocket"></i><?php echo e(_t('layout.optimize')); ?>
...
<script type="text/javascript">
    ...
    function loadSidebarTasks(filters) {
        ...
        return $.post('<?php echo e(route("admin.tasks.view")); ?>', {filters: filters}, function (response) {
    ...
    function refreshCachePartial() {
        ...
        return $.get('<?php echo e(route("optimizer.cache")); ?>', options, function (response) {
            target.html(response);
        });
    }
...
<?php /**PATH /app/app/Components/Themes/Base/Templates/Admin/Layout/quickSideBar.blade.php ENDPATH**/ ?>